...
const TermCondition = () => {
  return (
    ...
    <View>
        <ScrollView>
      <Text style={{textAlign:'justify'}}>Terms & Conditions: submitting material for publication
...
Users may submit material for publication under the following terms and condition
...
Interactions with our site are governed by our Community Standards , which expand on the points above and are incorporated in these Terms of Service. You will be deemed to consent to these guidelines if you choose to post any content or comments to the site.
...
The Conversation strives for fairness and accuracy at all times, and we encourage users to advise us of any significant errors.</Text>
</ScrollView>
    </View>
